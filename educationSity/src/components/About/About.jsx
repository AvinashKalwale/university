...
const About = ({setPlayVideo}) => {
  return (
    ...
    <p>Whether you inspire to become a teacher, administrator, counselor,
    or educational leadser, our diverse,range of programs offers the perfect pathway 
    to achieve your goals and unlock your full potential in shopping the future of education.</p>
    </div>
